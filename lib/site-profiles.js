...
(function () {
  ...
  var appliedElements = [];
  // #39: آخر CSS للـ profile النشط — لإعادة الحقن إذا حذفه التطبيق
  var _lastProfileCss = '';
  ...
  var PROFILES = {
    ...
    'grok.com': {
      ...
      css: [
        ...
        '}',
        '/* Grok: فقاعات الرسائل وردود النموذج — الموسوم تفوز بالغالبية */',
        '.message-bubble, .response-content-markdown,',
        '.message-bubble p:not([data-fluent-rtl-dir]), .message-bubble li:not([data-fluent-rtl-dir]),',
        '.response-content-markdown p:not([data-fluent-rtl-dir]), .response-content-markdown li:not([data-fluent-rtl-dir]) {',
        '  unicode-bidi: plaintext !important;',
        '  text-align: start !important;',
        '}',
    ...
    'aistudio.google.com': {
      ...
      css: [
        ...
        '/* #42: محددات مؤكدة من البنية الحية — ms-prompt-box + سمات Angular ثابتة */',
        'ms-prompt-box textarea,',
        '.prompt-box-container textarea,',
        '.textarea-row textarea,',
        'textarea[formcontrolname="promptText"],',
        'textarea[cdktextareaautosize],',
        'main textarea[placeholder*="prompt" i] {',
        '  unicode-bidi: plaintext !important;',
        '  text-align: start !important;',
        '}',
        '/* AI Studio: عرض النص داخل صندوق الإدخال */',
        'ms-prompt-box .text-wrapper,',
        '.prompt-box-container .text-wrapper,',
        '.textarea-row .text-wrapper {',
        '  unicode-bidi: plaintext !important;',
        '  text-align: start !important;',
        '}',
        '/* AI Studio: الرسائل (مع استثناء التفكير) — العناصر الموسومة تفوز بالغالبية */',
        'ms-chat-turn:not(:has(ms-thought-chunk)) .chat-turn-container,',
        'div.user-prompt-container, div.text-wrapper,',
        'ms-cmark-node p:not([data-fluent-rtl-dir]), ms-cmark-node li:not([data-fluent-rtl-dir]),',
        'ms-cmark-node blockquote:not([data-fluent-rtl-dir]) {',
        '  unicode-bidi: plaintext !important;',
        '  text-align: start !important;',
        '}',
        '/* #38/#43: شبكة أمان عامة — تعمل مع أي بنية مستقبلية، والوسوم تفوز */',
        'main p:not([data-fluent-rtl-dir]), main li:not([data-fluent-rtl-dir]),',
        'main blockquote:not([data-fluent-rtl-dir]) {',
        '  unicode-bidi: plaintext !important;',
        '  text-align: start !important;',
        '}',
        'main ul, main ol {',
    ...
    '127.0.0.1': {
      ...
      css: [
        ...
        '  text-align: start !important;',
        '}',
        '/* DSH: فقاعات المستخدم والمساعد — الموسوم تفوز بالغالبية */',
        '[data-chat-flow-kind="user"], [data-chat-flow-kind="steering"],',
        '[data-chat-flow-kind="assistant-step"],',
        '[data-chat-flow-kind="assistant-step"] p:not([data-fluent-rtl-dir]),',
        '[data-chat-flow-kind="assistant-step"] li:not([data-fluent-rtl-dir]),',
        '[data-chat-flow-kind="user"] .gdEzaW_bubble:not([data-fluent-rtl-dir]),',
        '[data-variant="think"] {',
        '  unicode-bidi: plaintext !important;',
        '  text-align: start !important;',
        '}',
        '/* #41: فقاعة المستخدم — قاعدة عامة لا تعتمد على نوع الصف */',
        '.gdEzaW_bubble:not([data-fluent-rtl-dir]), .gdEzaW_userStack .gdEzaW_bubble:not([data-fluent-rtl-dir]) {',
        '  unicode-bidi: plaintext !important;',
        '  text-align: start !important;',
        '}',
  ...
  /**
   * #39: إعادة حقن CSS الـ profile إذا حذفه التطبيق (بعض SPAs تنظف head)
   */
  function ensureProfileStyleAlive() {
    if (!activeProfileId || !_lastProfileCss) return;
    if (profileStyleEl && profileStyleEl.isConnected) return;

    profileStyleEl = document.createElement('style');
    profileStyleEl.id = 'fluent-rtl-site-profile';
    profileStyleEl.setAttribute('data-profile', activeProfileId);
    profileStyleEl.textContent = _lastProfileCss;
    document.head.appendChild(profileStyleEl);
  }
  ...
  window.FluentRTL.siteProfiles = {
    ...
    ensureProfileStyleAlive: ensureProfileStyleAlive,
